...
- Optional local PIN lock with five-minute inactivity locking, Android biometric unlock when supported, early Android `FLAG_SECURE` protection, Windows packaged content protection, neutral later-startup surfaces, and a clear privacy boundary
