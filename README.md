...
- Selecting a source asset now explains its practical role in the app: Facts & Info opens the guided educational surface, Strong's/Vine's opens Bible word study, and raw Hebrew/Greek/media/build files remain clearly marked as catalogued research
